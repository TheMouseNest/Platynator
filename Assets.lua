...
addonTable.Assets.BarBordersSliced = {
  ...
  ["bold"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/bold-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "bold", margin = 0.49, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2},
  ["slight"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/slight-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "slight", margin = 0.45, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2},
  ["thin"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/thin-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "thin", margin = 0.45, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2},
  ["1px"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/1px-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "1px", margin = 0.45, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2},
  ...
  ["blizzard-health"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/blizzard-health-square.png", width = 78, height = 78, has4k = true, masked = true, tag = "blizzard-health", margin = 0.43, extra = 0, padding = 11, displayPadding = 30, minSize = 100, modifier = 0.3, DPIScale = 1/2},
  ["blizzard-classic"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/blizzard-classic-square.png", width = 78, height = 78, has4k = true, masked = true, tag = "blizzard-classic", margin = 0.45, extra = 0, padding = 11, displayPadding = 30, minSize = 100, modifier = 0.3, DPIScale = 1/2},
  ["blizzard-cast-bar"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/blizzard-cast-bar-square.png", width = 78, height = 78, has4k = true, masked = true, tag = "blizzard-cast-bar", margin = 0.43, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2},
}
...
addonTable.Assets.Highlights = {
  ["bold"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/bold-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "bold", margin = 0.49, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2, mode = renderMode.Sliced},
  ["slight"] = {file = "Interface/AddOns/Platynator/Assets/%s/BarBorders/slight-square.png", width = 50, height = 50, has4k = true, masked = true, tag = "slight", margin = 0.45, extra = 0, padding = 11, displayPadding = 30, minSize = 50, modifier = 0.35, DPIScale = 1/2, mode = renderMode.Sliced},
