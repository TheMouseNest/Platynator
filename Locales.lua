...
L["USE_PRIMARY_SECONDARY_ENEMY_STYLES"] = "Use primary/secondary enemy styles"
L["SHOW_NAMEPLATES_ONLY_IF_NEEDED"] = "Show nameplates only if needed"
L["NEVER"] = "Never"
L["NAME_ONLY_PLAYERS"] = "Name only (players)"
L["SECONDARY_ENEMY"] = "Secondary Enemy"
L["ENEMY_PRIMARY_MOUSEOVER_PRIORITY"] = "Treat mouseover enemies as primary"
L["ENEMY_PRIMARY_SECONDARY_STYLE_SPLIT_HELP"] = "\"Primary\" enemies include enemies who are: targeted, soft targeted, focused, in combat with you or your group, and/or quest-related.\nPrimary enemies will use the style you select for Primary Enemy.\n\n\"Secondary\" enemies include any enemies which do not meet the criteria for \"primary\" enemies.\nSecondary enemies will use the style you select for Secondary Enemy."
L["ENEMY_PRIMARY_SECONDARY_DISABLED_HELP"] = "Enable primary/secondary enemy styles to change this setting."
...
L["ENABLE_COMBAT_OVERRIDE"] = "Enable combat override"
L["ENABLE_COMBAT_OVERRIDE_HELP"] = "When enabled, Combat tab styles override Default styles for units in combat with you or your group. If PvP overrides are active, PvP styles take priority for player units."
L["ENABLE_PVP_OVERRIDE_INSTANCES"] = "Enable PvP override in instances"
L["ENABLE_PVP_OVERRIDE_INSTANCES_HELP"] = "When enabled, PvP tab styles override Default/Combat styles for player units in PvP instances."
L["ENABLE_PVP_OVERRIDE_WORLD"] = "Enable PvP override in world"
L["ENABLE_PVP_OVERRIDE_WORLD_HELP"] = "When enabled, PvP tab styles override Default/Combat styles for player units in the open world."
L["DEFAULT"] = "Default"
L["COMBAT"] = "Combat"
...
L["TAPPED"] = "Tapped"
L["FOCUS"] = "Focus"
L["PRIMARY_ENEMY"] = "Primary Enemy"
L["PRIMARY_ENEMY_PLAYER"] = "Primary Enemy Player"
L["SECONDARY_PVP_ENEMY"] = "Secondary PvP Enemy"
