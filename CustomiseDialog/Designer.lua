...
function addonTable.CustomiseDialog.GetMainDesigner(parent)
  ...
  selectionTexture:SetTexture("Interface/AddOns/Platynator/Assets/selection-outline.tga")
  ...
  hoverTexture:SetTexture("Interface/AddOns/Platynator/Assets/selection-outline.tga")
