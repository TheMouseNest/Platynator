...
local function SetupBehaviour(parent)
  ...
  local mouseoverScaleSlider = addonTable.CustomiseDialog.Components.GetSlider(container, addonTable.Locales.ON_MOUSEOVER_SCALE, 1, 500, function(value) return ("%d%%"):format(value) end, function(value)
    addonTable.Config.Set(addonTable.Config.Options.MOUSEOVER_SCALE, value / 100)
  end)
  mouseoverScaleSlider:SetPoint("TOP", allFrames[#allFrames], "BOTTOM", 0, 0)
  table.insert(allFrames, mouseoverScaleSlider)
  ...
  container:SetScript("OnShow", function()
    ...
    mouseoverScaleSlider:SetValue(addonTable.Config.Get(addonTable.Config.Options.MOUSEOVER_SCALE) * 100)
